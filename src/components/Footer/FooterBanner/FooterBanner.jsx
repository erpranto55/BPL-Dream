...
const FooterBanner = () => {
    return (
        <div className='max-w-5xl mx-auto p-6 rounded-3xl min-h-96'>
            <div className='bg-linear-to-tr from-blue-200 to-orange-200 rounded-3xl flex flex-col justify-center text-center min-h-90 space-y-5'>
                <h2 className='font-bold text-3xl'>Subscribe to our Newsletter</h2>
                <h3 className='text-2xl text-gray-600'>Get the latest updates and news right in your inbox!</h3>
